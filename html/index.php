		...
		<div class="col-xs-12">
			<div class="gamePanel">
				...
				<div class="gameElements">
					...
					<div class="buttonControls" style="position: relative; top: 10px; left: 22px; z-index: 99999;">
						<button class="btn btn-xs btn-primary" id="upLevelButton">Level Up</button>
						<button class="btn btn-xs btn-primary" id="downLevelButton">Level Down</button>
					</div>
